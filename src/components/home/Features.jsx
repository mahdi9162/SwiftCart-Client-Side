...
const Features = () => {
  return (
    <section className="bg-slate-950 py-30 text-white border-t border-white/5">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight md:text-5xl">
              Built for a clean <span className="italic text-white/60">shopping flow</span>.
            </h2>
          ...
          {FEATURES.map((f, idx) => (
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-14 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/90">
                  {f.icon}
                </div>
